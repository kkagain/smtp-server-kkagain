 ...
 */
export async function handleSendEmail(parameters: any) {
  try {
 ...
 */
export async function handleSendBulkEmails(parameters: any) {
  try {
 ...
 */
export async function handleAddSmtpConfig(parameters: any) {
  try {
    ...
    const newConfig: SmtpServerConfig = {
      ...
      auth: {
        user: parameters.auth.user,
        pass: parameters.auth.pass
      },
 ...
 */
export async function handleUpdateSmtpConfig(parameters: any) {
  try {
    // Get existing configs
    const configs = await getSmtpConfigs();
 ...
 */
export async function handleDeleteSmtpConfig(parameters: any) {
  try {
    // Get existing configs
    const configs = await getSmtpConfigs();
 ...
 */
export async function handleAddEmailTemplate(parameters: any) {
  try {
 ...
 */
export async function handleUpdateEmailTemplate(parameters: any) {
  try {
    // Get existing templates
    const templates = await getEmailTemplates();
 ...
 */
export async function handleDeleteEmailTemplate(parameters: any) {
  try {
    // Get existing templates
    const templates = await getEmailTemplates();
